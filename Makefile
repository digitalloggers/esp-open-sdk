...
VENDOR_SDK_ZIP_1.5.1 = esp_iot_sdk_v1.5.1_16_01_08.zip
...
.sdk_patch_1.3.0:
	...
	patch -N -d $(VENDOR_SDK_DIR_1.3.0) -p1 < espconn-headers-unix.patch
	@touch $@
...
.sdk_patch_1.2.0: lib_mem_optimize_150714.zip libssl_patch_1.2.0-2.zip empty_user_rf_pre_init.o
	...
	patch -N -d $(VENDOR_SDK_DIR_1.2.0) -p1 < espconn-headers-unix.patch
...
esp_iot_sdk_v1.5.1_16_01_08.zip:
	wget --content-disposition "http://bbs.espressif.com/download/file.php?id=1046" -O $@
